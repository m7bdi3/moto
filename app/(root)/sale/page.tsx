...
export default function Component() {
  return (
    <div className="flex flex-col min-h-[100dvh]">
      <section className="w-full py-12 md:py-24 lg:py-0 bg-primary">
        <div className="container grid md:grid-cols-[.75fr_1fr] gap-6 px-4 lg:h-[calc(100vh-64px)] md:px-6 lg:gap-12">
          ...
          <Image
            ...
            height="550"
            alt="Sale Banner"
            className="m-auto aspect-video overflow-hidden rounded-md object-cover sm:w-full lg:order-last lg:aspect-square"
          />
        </div>
      </section>
            ...
            <div className="grid gap-4">
              <div className="grid gap-2.5 relative group">
                ...
                <Image
                  ...
                  width={300}
                  height={300}
                  className="rounded-md object-cover w-full aspect-square group-hover:opacity-50 transition-opacity"
                />
