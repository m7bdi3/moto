        ...
        <div className="container px-4 md:px-6 grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="flex justify-center">
            <Image
              ...
              height="400"
              alt="Newsletter"
              className="mx-auto aspect-[5/4] overflow-hidden rounded-xl object-cover"
            />
          </div>
        </div>
      </section>
            ...
            <Card className="p-6 bg-muted rounded-lg">
              <blockquote className="flex flex-col gap-4">
                <div className="text-lg font-medium leading-relaxed">
                  &quot;I look forward to your newsletter every week. The
                  deals\n and new product announcements are always so
                  helpful!&quot;
                </div>
            ...
            <Card className="p-6 bg-muted rounded-lg">
              <blockquote className="flex flex-col gap-4">
                <div className="text-lg font-medium leading-relaxed">
                  ...
                  newsletter has\n always been a valuable resource. Keep up the
                  great work!&quot;
                </div>
                <div className="flex items-center gap-4">
                  <Avatar>
            ...
            <Card className="p-6 bg-muted rounded-lg">
              <blockquote className="flex flex-col gap-4">
                <div className="text-lg font-medium leading-relaxed">
                  ...
                  newsletter. It&apos;s a great way to stay connected with
                  your\n brand.&quot;
                </div>
                <div className="flex items-center gap-4">
                  <Avatar>
