          ...
          <div className="container px-4 md:px-6 space-y-8 md:space-y-12">
            ...
            <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  <h3 className="text-lg font-semibold">Jane Arden</h3>
                  <p className="text-muted-foreground">Co-Founder, COO</p>
                  <p className="text-sm text-muted-foreground">
                    Jane has a background in supply chain management and
                    logistics.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Sarah has extensive experience in digital marketing and
                    brand building.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tom has a background in design and user experience
                    optimization.
                  </p>
                </div>
              </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 space-y-8 md:space-y-12">
            ...
            <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
              ...
              <div className="bg-muted rounded-lg p-6 flex flex-col gap-4">
                <div className="flex items-center justify-center bg-primary rounded-full w-12 h-12">
                  <SofaIcon className="w-6 h-6 text-primary-foreground" />
                </div>
                <h3 className="text-lg font-semibold">Home Decor</h3>
                <p className="text-muted-foreground">
                  Explore our collection of stylish and functional home decor
                  items to enhance your living space.
                </p>
                <Link
                  href="#"
                  className="inline-flex h-9 items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
              ...
              <div className="bg-muted rounded-lg p-6 flex flex-col gap-4">
                <div className="flex items-center justify-center bg-primary rounded-full w-12 h-12">
                  <GiftIcon className="w-6 h-6 text-primary-foreground" />
                </div>
                <h3 className="text-lg font-semibold">Gifts</h3>
                <p className="text-muted-foreground">
                  Find the perfect gift for any occasion, from birthdays to
                  holidays, and more.
                </p>
                <Link
                  href="#"
